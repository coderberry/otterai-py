...
class Folder(BaseModel):
    ...
    last_speech_added_at: Optional[int] = Field(None, description="Last speech added timestamp")
...
class MentionCandidatesResponse(BaseResponse):
    ...
    mention_candidates: List[MentionCandidate] = Field(..., description="List of mention candidates")